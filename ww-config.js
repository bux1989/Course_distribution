...
bindingValidation: {
type: 'array',
tooltip: 'Array of student rows from w_registration_period_students_by_day (includes day_of_week and current_enrollment).',
},
propertyHelp: { tooltip: 'Students with choices (window_id) and current enrollment (course_id or null) for the selected day.' },
/* wwEditor:end */
},
courses: {
label: { en: 'Courses' },
...
bindingValidation: {
type: 'array',
tooltip: 'Array of course rows from w_registration_period_courses_by_day.',
},
propertyHelp: { tooltip: 'Courses for the selected day.' },
/* wwEditor:end */
},
currentSemester: {
...
/* wwEditor:start */
bindingValidation: { type: 'string', tooltip: 'e.g., "Fall 2024"' },
propertyHelp: { tooltip: 'Shown in the header' },
/* wwEditor:end */
},
availableDays: {
...
/* wwEditor:start */
bindingValidation: { type: 'array', tooltip: 'Array of day names' },
propertyHelp: { tooltip: 'Legacy dropdown options' },
/* wwEditor:end */
},
daysOfWeek: {
...
/* wwEditor:start */
bindingValidation: { type: 'array', tooltip: 'Array of day objects (id, number, names)' },
propertyHelp: { tooltip: 'Days with IDs and localized names' },
/* wwEditor:end */
},
searchQuery: {
...
defaultValue: '',
/* wwEditor:start */
bindingValidation: { type: 'string', tooltip: 'Current search query' },
propertyHelp: { tooltip: 'Used for filtering students by name or class' },
/* wwEditor:end */
},
loading: {
...
defaultValue: false,
/* wwEditor:start */
bindingValidation: { type: 'boolean', tooltip: 'Show loading indicator' },
propertyHelp: { tooltip: 'Whether data is loading' },
/* wwEditor:end */
}
},
triggerEvents: [
